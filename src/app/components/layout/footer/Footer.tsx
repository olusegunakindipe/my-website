...
export default function Footer() {
  return (
    <>
      <footer
        id="contact"
        className="mx-auto max-w-7xl container text-white p-4 flex flex-col items-center"
      >
        <div className="flex flex-col gap-14 md:gap-0 md:flex-row w-full mt-12 md:my-24">
          <div className="bg-gray-900 w-full md:w-1/2 rounded-lg border border-gray-500 p-8">
            <h6 className="mb-2 uppercase text-gray-500">Get in Touch</h6>
            <h2 className="mb-3 font-bold text-3xl">Let's Discuss Projects</h2>
          ...
          <div className="md:!ml-auto">
            ...
            <iframe
              ...
              className="w-full border h-72 md:h-1/2 border-gray-500 rounded-lg p-2 mt-12 md:mt-4 mb-12"
